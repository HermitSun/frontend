            ...
            <el-collapse accordion>
                <el-collapse-item title="第一部分">
                    <div class="part1">
                        ...
                        <el-form-item label="MTP Number 台胞證號碼" prop="MTPNumber">
                            <el-input v-model="form.MTPNumber" placeholder="請輸入8位台胞證號碼" clearable style="width: 195px;"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="TELEPHONE 電話號碼" v-model="phoneNumber" label-width="195px">
                            ...
                            <el-form-item label="Home 住宅" prop="home">
                                <el-input v-model="form.phoneNumber.home" placeholder="" clearable style="width: 195px;"></el-input>
                            </el-form-item>
                    ...
                    <div class="part2">
                        ...
                        <el-form-item v-model="curriculumChoices">
                            <el-form-item label="1st choice 第一志願" prop="firstChoice" label-width="155px">
                                <!--接口文檔first拼錯-->
                                <el-select v-model="form.curriculumChoices.firstChoice" placeholder="請選擇第一志願" style="width: 300px;">
                            ...
                            <el-form-item label="2st choice 第二志願" prop="secondChoice" label-width="155px">
                                <el-select v-model="form.curriculumChoices.secondChoice" placeholder="請選擇第二志願" style="width: 300px;">
                                    <el-option label="軟件工程"></el-option>
                                    <el-option label="經濟管理實驗班"></el-option>
                            ...
                            <el-form-item label="3st choice 第三志願" label-width="155px">
                                <el-select v-model="form.curriculumChoices.thirdChoice" placeholder="請選擇第三志願" style="width: 300px;">
                                    <el-option label="軟件工程"></el-option>
                                    <el-option label="經濟管理實驗班"></el-option>
                                    <el-option label=""></el-option>
                                </el-select>
                            ...
                            <el-form-item label="4st choice 第四志願" label-width="155px">
                                <el-select v-model="form.curriculumChoices.fourthChoice" placeholder="請選擇第四志願" style="width: 300px;">
                                    <el-option label="軟件工程"></el-option>
                                    <el-option label="經濟管理實驗班"></el-option>
                                    <el-option label=""></el-option>
                                </el-select>
                ...
                <el-collapse-item title="第三部分">
                    <div class="part3">
                        <el-row>
                            ...
                            Name of schools attended the present school. Please state the province and city that the school is
                            located. 中文填寫就讀學校。
                        </el-row>
                        ...
                        <el-form ref="form1" :inline="true" model="form1" label-width="160px">
                            ...
                            <el-form-item v-model="juniorMiddleSchool" prop="juniorMiddleSchool">
                                <table>
                                    <tr>
                                        <td width="200px">
                            ...
                            <el-form-item v-model="seniorMiddleSchool" prop="seniorMiddleSchool">
                                <table>
                                    <tr>
                                        <td width="200px">
                ...
                <el-collapse-item title="第四部分">
                    <div class="part4">
                        <el-row>
                            <el-col :span="24">
                                <div class="title grid-content bg-purple-dark">四. PARTICULARS OF FAMILY MEMBERS 申請者家屬情況</div>
                            </el-col>
                        </el-row>
                        请至少填写一个家属信息！
                        <el-form :model="familyParticulars" ref="familyParticulars" label-width="0">
                            ...
                            >
                                <el-input v-model="member.relationship" placeholder="Relationship 關係"  style="width: 180px"></el-input>
                                <el-input v-model="member.name" placeholder="NAME 姓名" style="width: 180px"></el-input>
                                <el-input v-model="member.organization" placeholder="Company 單位名稱" style="width: 180px"></el-input>
                                <el-input v-model="member.occupation" placeholder="Occupation 職務" style="width: 180px"></el-input>
                                <el-input v-model="member.phoneNumber"placeholder="Mobile 手機" style="width: 180px"></el-input>
                ...
                <el-collapse-item title="第五部分">
                    <div class="part5">
                        <el-row>
                            <el-col :span="24">
                                <div class="title grid-content bg-purple-dark">五. RESULT OF GENERAL SCHOLASTIC ABILITY TEST (ATTACH
                                    A COPY OF RESULT<br/>
                                    台灣地區大學入學考試學科能力測驗成績（請附考生成績通知單影印本）
                                </div>
                            </el-col>
                        </el-row>
                        <el-form-item v-model="gsatResult">
                            <table>
                                <tr>
                                    <td>Results <br/>成績</td>
                ...
                <el-collapse-item title="第六部分">
                    <div class="part6">
                        <el-row>
                            <el-col :span="24">
                                <div class="title grid-content bg-purple-dark">六. EXTRA-CURRICULAR ACTIVITIES, AND AWARDS
                                    高中階段課外活動及所獲獎項
                                </div>
                            </el-col>
                            Please provide the information of the extra-curricular activities and voluntary services you have
                            participated in, and awards you have won in the past three years, in both Chinese and English.
                        ...
                        <el-form :model="activities" ref="activities" label-width="0">
                            ...
                            >
                                <el-input v-model="activity.organization" placeholder="Name of organization頒發/主辦單位" style="width: 260px;"></el-input>
                                <el-input v-model="activity.award" placeholder="Name of award/activity獎項/活動名" style="width: 360px;"></el-input>
                                <el-input v-model="activity.attendingDate" placeholder="Date of issue/participation獲獎/參與日期" style="width:290px;"></el-input>
                ...
                <el-collapse-item title="第七部分">
                    <div class="part7">
                        <el-row>
                            ...
                            NOTES: Write briefly your reasons for applying to study at Nanjing University, outlining the curricula which
                            you are interested in, your career aspirations and any other information you consider relevant, within 500
                            Chinese characters.
