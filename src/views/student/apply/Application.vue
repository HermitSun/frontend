            ...
            <el-form v-model="gsatResult">
                <table>
                    <tr>
                        <td>Results <br/>成績</td>
                        <td>
                            <el-form-item v-model="chinese">
                                <el-input placeholder="CHINESE 國文"></el-input>
                            </el-form-item>
                        </td>
                        <td>
                            <el-form-item v-model="math">
                                <el-input placeholder="MATH 數學"></el-input>
                            </el-form-item>
                        </td>
                        <td>
                            <el-form-item v-model="english">
                                <el-input placeholder="ENGLISH 英文"></el-input>
                            </el-form-item>
                        </td>
                        <td>
                            <el-form-item v-model="socials">
                                <el-input placeholder="SOCIAL 社會"></el-input>
                            </el-form-item>
                        </td>
                        <td>
                            <el-form-item v-model="sciences">
                                <el-input placeholder="SCIENCES 自然"></el-input>
                            </el-form-item>
                        </td>
                    </tr>
                    <tr>
            ...
            <el-form v-model="familyParticulars">
                <table align="center">
                    <tr>
                        ...
                        <td width="300px">
                            <el-form-item v-model="name">
                                <el-input placeholder="Name of organization頒發/主辦單位" style="width: 260px;"></el-input>
                            </el-form-item>
                        </td>
                        <td width="400px">
                            <el-form-item v-model="organization">
                                <el-input placeholder="Name of award/activity獎項/活動名" style="width: 360px;"></el-input>
                            </el-form-item>
                        </td>
                        <td width="300px">
                            <el-form-item v-model="occupation">
                                <el-input placeholder="Date of issue/participation獲獎/參與日期"
